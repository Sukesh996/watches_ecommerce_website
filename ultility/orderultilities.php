...
function getOrderStatus($con, $status) {
    switch ($status) {
        ...
        case 2:
            return "<span style='color: green; font-weight:bold'>Preparing goods</span>";
        case 3:
            return "<span style='color: green; font-weight:bold'>
            Shipping in progress</span>";
        case 4:
            return "<span style='color: blue; font-weight:bold'>Has received the goods</span>";
        case 5:
