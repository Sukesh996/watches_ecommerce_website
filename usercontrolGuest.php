...
Address: </td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><input type="submit" name="btnSubmit" value="Update" /> <input type="reset" name="btnReset" value="
Retype" /></td>
                                        </tr>
                                    </table>
                                </form>
                                ...
                                if (isset($_SESSION['userId'])) {
                                    if (isset($_POST['txtAddress'])) {
                                        if ($result) {
                                ?>
                                    <p class="pResultLogin">Successfully entered information.</p>
                                <?php
                                        } else {
                                ?>
...
Status</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo getOrderTotal($con, $row['Id'])." Rs"; ?>
                                            </span>
                                        </td>
                                        <td>
